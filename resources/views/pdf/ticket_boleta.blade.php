...
<div class="container">
    ...
    <div class="item"><span class="texto">BOLETA ELECTRÓNICA {{$data->vent_venta_serie}}
    ...
    <div class="item2">DOC. IDENT.: {{$data->vent_venta_cliente_numero_documento}}</div>
    ...
    <div class="item">Autorizado mediante Resolución de Intendencia N° 032-005-Representación impresa de la Boleta
        Electrónica. Consulte su documento electrónico en: <!--<br/> https://bit.ly/2HiRWZI-->
    </div>
