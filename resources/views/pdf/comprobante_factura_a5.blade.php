...
<table class="tablareceipt">
    ...
    <tr>
        <td>
            ...
            <p style="text-transform: none !important;"> Cel.: {{$data->alm_almacen_telefono}}</p>
        </td>
        <td class="datoruc">
            <p>R.U.C. {{$data->empresa->emp_empresa_ruc}}</p>
            <p>{{$data->doc_tipo_comprobante_nombre}} DE VENTA ELECTRÓNICA</p>
            <p>SERIE: {{$data->vent_venta_serie}}</p>
            <p>NÚMERO DE VENTA: {{$data->vent_venta_numero}}</p>
        </td>
    </tr>
    </tbody>
</table>
    ...
    <tr>
        <td class="tdatoslabel">
            <div style="padding-bottom: 10px; padding-right: 19px;">
                ...
                <div style="margin-left: 95px; border-bottom: solid 1px #000;">{{$data->cliente}}</div>
            </div>
        </td>
        <td class="tdatoslabel tdatodlabeldos">
            <div>
                <span style="float: left;">Fecha de Emisión:</span>
                <div style="margin-left: 118px; border-bottom: solid 1px #000;"> {{$data->vent_venta_fecha}}</div>
            </div>
        </td>
    </tr>
    <tr>
        <td class="tdatoslabel">
            <div style="padding-bottom: 10px; padding-right: 19px;">
                ...
                <div style="margin-left: 95px; border-bottom: solid 1px #000;"> {{$data->vent_venta_cliente_numero_documento}} </div>
            </div>
        </td>
        <td class="tdatoslabel tdatodlabeldos">
            <div>
    ...
    <tr>
        <td class="tdatoslabel">
            <div style="padding-bottom: 10px; padding-right: 19px;">
                ...
                <div style="margin-left: 95px; border-bottom: solid 1px #000;">  {{$data->cliente_direccion}}
                </div>
            </div>
        </td>
    </tr>
...
<div class="tablageneral tablacostos">
    <table cellpadding="0" cellspacing="0">
        ...
        <tr class="detalletable">
            ...
            <td class="preciotabla ulttable fintabla">{{$data->vent_venta_bi}}</td>
        </tr>
        <tr class="detalletable">


            <td class="preciotabla fintabla fintablados"><b>I.G.V. (18%)</b></td>
            <td class="preciotabla ulttable fintabla">{{$data->vent_venta_igv}}</td>
        </tr>
        <tr class="detalletable">
        ...
        <tr>
            <td rowspan="3">
                <div style="clear: both; padding-bottom: 25px; width: 260px;">
                    Autorizado mediante Resolución de Intendencia N° 032-005-Representación impresa de la Boleta
                    Electrónica. Consulte su documento electrónico en:
