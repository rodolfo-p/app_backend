...
<table class="tablareceipt">
    ...
    <tr>
        <td>
            ...
            <p style="text-transform: none !important;"> Email: {{$data->alm_almacen_email}}</p>
        </td>
        <td class="datoruc">
...
<div class="tablageneral tablacostos tablaboleta">
    <table cellpadding="0" cellspacing="0">
        <tbody>
        <tr class="detalletable">
            <td colspan="2">SON: {{$data->vent_venta_precio_cobrado_letras}} SOLES</td>
...
<table cellpadding="0" cellspacing="0" class="tablacan">
    ...
    <tr>
        ...
        <td style="text-align: center;"><img
                    src="data:image/png;base64,{{DNS2D::getBarcodePNG($data->vent_venta_qr, 'QRCODE')}}" alt="barcode"
                    width="150" height="150" align="center"/>
        <td>
            <div>Autorizado mediante Resolución de Intendencia N° 032-005-Representación impresa de la Boleta
                Electrónica. Consulte su documento electrónico en: <br/> <span style="font-size: 10px">https://bit.ly/2HiRWZI</span>
            </div>
