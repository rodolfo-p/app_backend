...
class ComRecetasController extends Controller
{
    public function registrar_compra(Request $request)
    {
        ...
        $compra_data->comp_compra_serie = 'RE01';
        ...
        $compra_data->comp_compra_tipo = 'RE';
        $compra_data->comp_compra_desc = $request->input('comp_compra_desc');
        $compra_data->comp_compra_receta_nombre = $request->input('comp_compra_receta_nombre');
        $compra_data->comp_compra_receta_rendimiento = $request->input('comp_compra_receta_rendimiento');
        ...
        return response()->json(['success' => true,
            'data' => Pagination::paginatorFacturaPeru(Compra::select(
                ...
                'comp_compra.comp_compra_receta_nombre',
                'comp_compra.comp_compra_receta_rendimiento',
                ...
                ->where('comp_compra.comp_compra_tipo', 'RE')
    ...
    public function listar_compras(Request $request)
    {
        ...
        if (!is_null($request->input('comp_compra_fecha_desde')) &&
            ...
            $condicional_fecha = [date('2020-01-01'), date('2050-12-12')];
        }
        return response()->json(['success' => true,
            'data' => Pagination::paginatorFacturaPeru(Compra::select(
                'alm_proveedor.alm_proveedor_razon_social',
